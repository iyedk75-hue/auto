...
The repository already contains a Laravel 12 application with authentication, candidate and admin dashboards, course CRUD, candidate course listing/detail pages, inline PDF/video support in rough form, and single-device binding for candidate logins. The public landing page still contains an anti-piracy marketing block the user wants removed. Localization scaffolding is not yet in place, and protected lesson assets are currently uploaded to public storage.
