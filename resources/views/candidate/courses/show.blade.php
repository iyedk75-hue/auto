        ...
        <div class="mx-auto max-w-5xl space-y-8 px-4 sm:px-6 lg:px-8">
            <div class="classroom-hero">
                ...
                <div class="classroom-hero-content">
                    ...
                    @if ($course->duration_minutes)
                        <p class="text-sm font-semibold text-slate-500">Durée estimée : {{ $course->duration_minutes }} minutes</p>
                    @endif
                </div>
            </div>
            ...
            <div class="grid gap-6 lg:grid-cols-[2fr_1fr]">
                <div class="space-y-6">
                    @if ($course->media_path)
                        ...
                        <div class="classroom-section">
                            <p class="classroom-section-title">Support principal</p>
                            <div class="mt-4">
                    ...
                    <div class="classroom-section">
                        <p class="classroom-section-title">À propos du cours</p>
                        @if ($course->description)
                            <p class="classroom-section-text">{{ $course->description }}</p>
                        @else
                            <p class="classroom-section-text">Ce module fait partie du parcours Massar pour la préparation au code.</p>
                        @endif
                    </div>

                    @if ($course->content)
                        <div class="classroom-section">
                            <p class="classroom-section-title">Contenu</p>
                    ...
                    @if ($course->pdf_path)
                        <div class="classroom-section">
                            <p class="classroom-section-title">Ressource PDF</p>
                            <p class="classroom-section-text">Lecture en ligne uniquement.</p>
                ...
                <aside class="space-y-6">
                    <div class="classroom-section">
                        <p class="classroom-section-title">Infos rapides</p>
                        <div class="mt-4 space-y-3 text-sm text-slate-600">
                            <div class="flex items-center justify-between">
                                <span>Statut</span>
                                <span class="font-semibold text-slate-900">Actif</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span>Durée</span>
                                <span class="font-semibold text-slate-900">{{ $course->duration_minutes ? $course->duration_minutes.' min' : 'Libre' }}</span>
                            </div>
                            <div class="flex items-center justify-between">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('courses.index') }}" class="btn-ghost w-full justify-center">Retour aux cours</a>
                        </div>
                    </div>
                </aside>
            </div>
